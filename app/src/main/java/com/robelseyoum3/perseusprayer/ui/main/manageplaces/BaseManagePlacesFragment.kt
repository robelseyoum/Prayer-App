...
abstract class BaseManagePlacesFragment : DaggerFragment() {
    ...
    lateinit var viewModel: ManagePlacesViewModel

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        viewModel = activity?.run {
            ViewModelProvider(this, providerFactory).get(ManagePlacesViewModel::class.java)
